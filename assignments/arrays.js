...
let lastCar = 0;
console.log(
  `make is ${inventory[inventory.length - 1].car_make}. model is ${
...
let oldCars = [
  inventory.filter(carInventory => carInventory.car_year < 2000).length
];
console.log(oldCars);
...
let BMWAndAudi = [
  inventory.filter(
    carInventory =>
      carInventory.car_make === 'BMW' || carInventory.car_make === 'Audi'
  )
];
